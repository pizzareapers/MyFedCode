...
class PACS_FedDG():
    def __init__(self, test_domain, batch_size, use_cache=True, cache_size=1000):
    ...
    def _create_single_site(self, domain_name, batch_size=16, use_cache=True, cache_size=1000):
        dataset_dict = {
